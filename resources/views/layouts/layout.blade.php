          ...
          <ul class="menu-inner py-1">
              ...
              <ul class="menu-sub">
                ...
                <!-- <li class="menu-item">
                  <a
                    ...
                    <div class="badge bg-label-primary fs-tiny rounded-pill ms-auto">Beta</div>
                  </a>
                </li> -->
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Product manager</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="layouts-without-menu.html" class="menu-link">
                    <div data-i18n="Without menu">Show detail</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="layouts-without-navbar.html" class="menu-link">
                    <div data-i18n="Without navbar">Show inventory</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Front Pages">Bill manager</div>
                <!-- <div class="badge bg-label-primary fs-tiny rounded-pill ms-auto">Pro</div> -->
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a
                    ...
                    class="menu-link"
                    target="_blank">
                    <div data-i18n="Landing">Create Bill</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a
                    ...
                    class="menu-link"
                    target="_blank">
                    <div data-i18n="Pricing">History Bill</div>
                  </a>
                </li>
